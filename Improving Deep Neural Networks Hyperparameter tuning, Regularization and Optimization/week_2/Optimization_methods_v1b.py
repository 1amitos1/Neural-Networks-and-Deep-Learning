...
def random_mini_batches(X, Y, mini_batch_size = 64, seed = 0):
    ...
    if m % mini_batch_size != 0:
        ### START CODE HERE ### (approx. 2 lines)
        mini_batch_X = shuffled_X[:,num_complete_minibatches :(m - mini_batch_size * num_complete_minibatches + num_complete_minibatches) ]
        mini_batch_Y = shuffled_Y[:,num_complete_minibatches :(m - mini_batch_size * num_complete_minibatches +num_complete_minibatches) ]
        ### END CODE HERE ###
        mini_batch = (mini_batch_X, mini_batch_Y)
        mini_batches.append(mini_batch)
